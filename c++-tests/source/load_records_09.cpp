// Add 34721 records to large file by single-step deferred update indexed by same key.

// This succeeds if 65279 records are on file when run.
...
int main()
{
    std::cout << "enter load_records_09\n";
