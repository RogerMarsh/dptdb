// Add 130460 records to file by single-step deferred update with each key indexing 6 records.
// The load is done in two 65280 record chunks.
...
int main()
{
    std::cout << "enter load_records_09" << std::endl;
    ...
    std::cout << "leave load_records_09" << std::endl;
}
