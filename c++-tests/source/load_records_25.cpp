// load_records_25.cpp
// Add 65281 records to file by normal update with one key indexing 3 records in segment 0.
...
int main()
{
    std::cout << "enter load_records_25" << std::endl;
    ...
    std::cout << "leave load_records_25" << std::endl;
}
