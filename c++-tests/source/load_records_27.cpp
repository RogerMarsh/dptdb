...
// This job does step 1 which writes TAPEA and TAPEN files containing the unsorted index references.
...
int main()
{
    std::cout << "enter load_records_27" << std::endl;
    ...
    std::cout << "leave load_records_27" << std::endl;
    std::cout << "(expecting to run load_records_28)" << std::endl;
}
