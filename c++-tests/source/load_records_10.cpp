// Add 34722 records to large file by single-step deferred update indexed by same key.

// This fails if 65279 records are on file when run.
...
int main()
{
    ...
    for (int i = 0; i < 34722; ++i) {
        add_record(context, std::to_string(i), "e");
    };
    std::cout << "34722 records stored\n";
