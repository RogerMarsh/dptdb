// Add 65281 records to file by single-step deferred update with each key indexing 999 records.
...
int main()
{
    std::cout << "enter load_records_17" << std::endl;
    ...
    std::cout << "65281 records stored 999 records per key" << std::endl;
    dbserv.CloseContext(context);
    std::cout << "context closed" << std::endl;
    dbserv.Free("TSTSMALL");
    std::cout << "leave load_records_17" << std::endl;
}
