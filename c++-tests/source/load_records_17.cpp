// Add 65281 records to 75000 record file by single-step deferred update with each key indexing 999 records.
...
int main()
{
    std::cout << "enter load_records_17\n";
    ...
    std::cout << "65281 records stored 999 records per key\n";
    dbserv.CloseContext(context);
    std::cout << "context closed\n";
    dbserv.Free("TSTSMALL");
    std::cout << "leave load_records_17\n";
}
