// Add 65280 records to 75000 record file by single-step deferred update with each key indexing 1000 records.
...
int main()
{
    std::cout << "enter load_records_14\n";
    ...
    std::cout << "65280 records stored 1000 records per key\n";
    dbserv.CloseContext(context);
    std::cout << "context closed\n";
    dbserv.Free("TSTSMALL");
    std::cout << "leave load_records_14\n";
}
