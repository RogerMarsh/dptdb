// Add 65281 records to 75000 file by single-step deferred update with each key indexing 7 records.
...
int main()
{
    std::cout << "enter load_records_11\n";
    ...
    std::cout << "65281 records stored 7 records per key\n";
    dbserv.CloseContext(context);
    std::cout << "context closed\n";
    dbserv.Free("TSTSMALL");
    std::cout << "leave load_records_11\n";
}
