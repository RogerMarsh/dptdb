# create_x86_200000_5021_deferred.py
...
if __name__ == "__main__":
    print("start create_x86_200000_5021_deferred")
    run_test_create_databases.rtcd_data_data_ord_inv(
        default_records=200000, modulus=13
    )
    print("finish create_x86_200000_5021_deferred")
