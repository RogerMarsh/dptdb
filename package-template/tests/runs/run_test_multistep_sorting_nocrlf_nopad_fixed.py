# run_test_multistep_sorting_nocrlf_nopad_fixed.py
...
Set du_fixed_length=20 which is more than longest ORD NUM index value
...
if __name__ == "__main__":
    ...
    run_test_multistep_sort.run_test_multistep_sort(
        ...
        du_fixed_length=20,
        du_format_options=(
            dptdb.dptapi.DU_FORMAT_NOCRLF | dptdb.dptapi.DU_FORMAT_NOPAD
        ),
