# run_test_traverse_600_low_viii_65280.py
# Copyright 2023 Roger Marsh
# License: BSD license

"""Traverse recordsets from run_test_vis_inv_inv_inv_65280_deferred run.

Recordsets for index values with less than 600 records are excluded,

This should include bitmap but exclude large list representations of
inverted lists.
...
if __name__ == "__main__":
    run_test_traverse_records_viii_65280.rttr_viii_65280(
        ...
        modulus=13,
        btod_factor=400,
        lower_count_limit=600,
    )
    print("run_test_traverse_600_low_viii_65280", "done")
