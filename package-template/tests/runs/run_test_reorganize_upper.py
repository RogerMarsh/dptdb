...
The database is expected to be created by a
run_test_create_and_populate_upper_* run.

This version of run_testreorganize module exists to demonstrate fastload
is incompatible with field names which are not uppercase.
