# v3r0_vs2026_cl_c++latest_copy.Makefile
# Run in a Msys2 MSYS shell on Microsoft Windows.

# make -f v3r0_vs2026_cl_c++latest_copy.Makefile
...
include Mk/sed_resource_lockinfo.Mk
include Mk/vs_sed_ord_comp_ptr_int.Mk
